...
ChordFont does not tokenize at render time — glyph binding is specified by GSUB
shape tests (`packages/font/tests/shape_test.py`). Font-package detail:
`packages/font/DECISIONS.md` ADR-007.
